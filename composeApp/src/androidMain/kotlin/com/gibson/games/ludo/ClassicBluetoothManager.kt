...
class ClassicBluetoothManager(
    ...
    companion object {
        private const val SERVICE_NAME = "KadwiseLudoBluetooth"
    ...
    fun startServer(
        ...
        serverThread = Thread {
            try {
                val serverSocket =
                    btAdapter.listenUsingRfcommWithServiceRecord(SERVICE_NAME, SERVICE_UUID)
                ...
                mainHandler.post {
                    onError("Failed to host Bluetooth game: ${e.message ?: "unknown error"}")
                }
